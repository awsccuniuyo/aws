...
const partners: Partner[] = [
  ...
  { name: 'AWS User Group',     description: 'AWS User Group Nigeria is a community-driven group of cloud professionals, developers, and enthusiasts across Nigeria who are passionate about Amazon Web Services. As one of the most active AWS communities on the continent, they organise meetups, workshops, and knowledge-sharing sessions that connect students with experienced cloud practitioners. Partnering with AWS User Group Nigeria gives our members direct access to a wider network of AWS professionals, mentorship opportunities, and a pathway from student builder to industry-ready cloud engineer.', logo: '/partners/partner2.png', website: '#', category: 'community' },
  { name: 'University of Uyo (UniUyo)',       description: 'The University of Uyo is one of Nigeria leading federal universities, home to thousands of students across science, technology, engineering, and mathematics disciplines. As our host institution, UniUyo provides the foundation and environment from which AWS Cloud Club UniUyo operates connecting academic learning with real-world cloud skills and giving our members the institutional backing to grow, build, and represent Nigerian tech on a global stage.', logo: '/partners/partner3.png', website: '#', category: 'Tertiary institution' },
  { name: 'NodeXplorer', description: 'NodeXplorer is a student-built tech community and platform born right here in Nigeria, dedicated to exploring the intersection of blockchain, web3, and emerging technologies. As a community partner, NodeXplorer brings its network of curious builders and developers into the AWS Cloud Club ecosystem, bridging the gap between web3 innovation and cloud infrastructure, and opening doors for members interested in the next frontier of tech.', logo: '/partners/partner4.png', website: '#', category: 'community' },
]
